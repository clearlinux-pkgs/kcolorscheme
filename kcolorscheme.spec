...
Source0  : https://download.kde.org/stable/frameworks/6.11/kcolorscheme-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/kcolorscheme-6.11.0.tar.xz.sig
...
%setup -q -n kcolorscheme-6.11.0
cd %{_builddir}/kcolorscheme-6.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739560823
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF6ColorScheme.so.6.11.0
