...
Version  : 6.4.0
Release  : 9
URL      : https://download.kde.org/stable/frameworks/6.4/kcolorscheme-6.4.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.4/kcolorscheme-6.4.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.4/kcolorscheme-6.4.0.tar.xz.sig
...
%setup -q -n kcolorscheme-6.4.0
cd %{_builddir}/kcolorscheme-6.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720996352
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF6ColorScheme.so.6.4.0
