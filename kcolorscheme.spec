...
Source0  : https://download.kde.org/stable/frameworks/6.13/kcolorscheme-6.13.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.13/kcolorscheme-6.13.0.tar.xz.sig
...
%setup -q -n kcolorscheme-6.13.0
cd %{_builddir}/kcolorscheme-6.13.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744643345
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF6ColorScheme.so.6.13.0
