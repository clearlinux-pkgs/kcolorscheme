...
Source0  : https://download.kde.org/stable/frameworks/6.10/kcolorscheme-6.10.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.10/kcolorscheme-6.10.0.tar.xz.sig
...
%setup -q -n kcolorscheme-6.10.0
cd %{_builddir}/kcolorscheme-6.10.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736722598
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libKF6ColorScheme.so.6.10.0
